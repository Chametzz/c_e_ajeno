"""
views/pantalla_calificaciones.py
Vista general de calificaciones con filtro por estudiante.
"""
...
def _color_cal(val):
    if val is None: return get_color_from_hex("#9E9E9E")
    if val >= 90:   return get_color_from_hex("#1B5E20")
    if val >= 70:   return get_color_from_hex("#1565C0")
